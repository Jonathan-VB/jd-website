...
function jd_theme_styles() {
  wp_enqueue_style( 'main_css', get_template_directory_uri() . '/assets-prod/css/main.css' );
}
...
function jd_theme_js() {
  if( is_front_page() ) {
    wp_enqueue_script( 'home_js', get_template_directory_uri() . '/assets-prod/js/home.js', array('jquery'), '', true );
  }

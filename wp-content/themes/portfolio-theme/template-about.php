      ...
      <div class="about-content">
        ...
        <div class="about-content--right">
          ...
          <div class="about__icons">
            ...
            <?php if( get_field( 'about_me_linkedin' ) ) : ?>

              <a href="<?php echo the_field( 'about_me_linkedin' ); ?>" target="_blank" rel="noopener noreferrer" title="Link to Jonathan Dempsey's LinkedIn profile">
            ...
            <?php if( get_field( 'about_me_github' ) ) : ?>

            <a href="<?php echo the_field( 'about_me_github' ); ?>" target="_blank" rel="noopener noreferrer" title="Link the Jonathan Dempsey's Github profile">
              <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 438.536 438.536">
                <g>
            ...
            <?php if( get_field( 'about_me_gmail' ) ) : ?>

            <a href="mailto:<?php echo the_field( 'about_me_gmail' ); ?>" title="Link to open the user's mail application with Jonathan's email entered into the TO field">

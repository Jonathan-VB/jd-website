        ...
        <div class="about-content--right">
          ...
          <div class="about__icons">
            ...
            <?php if( get_field( 'about_me_linkedin' ) ) : ?>
              ...
              <a href="<?php echo the_field( 'about_me_linkedin' ); ?>" target="_blank" rel="noopener noreferrer">
            ...
            <a href="<?php echo the_field( 'about_me_github' ); ?>" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 438.536 438.536">
                <g>
            ...
            <a href="mailto:<?php echo the_field( 'about_me_gmail' ); ?>">

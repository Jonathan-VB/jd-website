...
<section class="portfolio" id="portfolio">
  ...
  <?php if( $portfolioItem->have_posts() ):
    while( $portfolioItem->have_posts() ) : $portfolioItem->the_post();
      ...
      <div class="portfolio-background scroll-point" style="background: linear-gradient(rgba(0,0,0,.6), rgba(0,0,0,.7)), url('<?php echo $image[0]; ?>'); no-repeat center center; background-size: cover; background-position: center center;">
      </div>
